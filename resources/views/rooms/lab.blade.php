...
<body class="bg-stone-50">
    ...
    <main class="pt-24 pb-16">
        <div class="max-w-7xl mx-auto px-4 lg:px-8">
            ...
            <!-- Page Header -->
            <div class="mb-12">
                <h1 class="text-4xl lg:text-5xl font-bold text-stone-900 mb-4">Ruang Laboratorium</h1>
                <p class="text-lg text-stone-600">Tersedia {{ count($rooms) }} Ruang Laboratorium yang memiliki PC yang lengkap</p>
            </div>
            <!-- Room Grid -->
            @if (count($rooms) == 0)
                <div class="flex flex-col items-center justify-center py-16 px-4 bg-white rounded-2xl shadow-sm">
                    ...
                    <h2 class="text-3xl font-bold text-stone-800 mb-3">Tidak Ada Ruangan Laboratorium</h2>
                    <p class="text-lg text-stone-600 text-center max-w-md">Mohon maaf, saat ini tidak ada ruangan laboratorium yang tersedia untuk ditampilkan. Silakan cek kembali nanti.</p>
                </div>
            @else
