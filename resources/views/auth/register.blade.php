...
@section('content')
    <div class="flex h-screen overflow-hidden">
        ...
        <!-- Right Pane with Forms Container -->
        <div
            ...
            <div class="max-w-2xl h-full w-full relative z-10">
                <div id="forms-container" class="relative w-full h-full transition-transform duration-500 ease-in-out"
                    ...
                    <div class="absolute inset-0 w-full h-full flex items-center justify-center">
                        <div
                            class="w-full bg-white rounded-lg p-8 flex flex-col items-center shadow-2xl max-h-[95vh] overflow-y-auto">
                            <!-- Header Section -->
                            <div class="w-full mb-6">
                                <div class="flex items-center justify-center mb-4">
                                    <img src="{{ asset('logoPeminjaman.png') }}" alt="Logo" class="w-32">
                                </div>
                                <h1 class="text-4xl font-bold mb-2 text-[#F50057] text-center">Register</h1>
                                <p class="text-sm text-gray-500 text-center">Buat Akun Baru</p>
                                <div class="w-20 h-1 bg-[#F50057] mx-auto mt-3 rounded-full"></div>
                            </div>



                            <form action="{{ route('register') }}" method="POST" class="space-y-4 w-full px-10">
                                @csrf
                                <div>
                                    <label for="email"
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="email" id="email" name="email" placeholder="Masukkan email"
                                            class="pl-10 mt-1 p-3 w-full text-stone-900 border border-gray-300 rounded-lg focus:border-[#F50057] focus:outline-none focus:ring-2 focus:ring-[#F50057] focus:ring-opacity-20 transition-all duration-300">
                                    </div>
                                    @error('email')
                            ...
                            <div class="text-center">
                                ...
                                <a href="/login">
                                    <button)
                                        class="text-[#F50057] hover:underline font-bold text-base inline-flex items-center mt-1 cursor-pointer">
