...
@section('content')
    <div class="mb-6 flex justify-between items-center">
        <h1 class="text-2xl font-bold text-stone-900">Facilities Management</h1>
        <a href="{{ route('facilities.create') }}" class="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700">
            Add New Facility
        </a>
    </div>
                ...
                <tbody class="divide-y divide-stone-200">
                    @forelse($facilities as $facility)
                        <tr class="hover:bg-stone-50">
                            <td class="px-6 py-4 font-medium text-stone-900">{{ $facility->name }}</td>
                            <td class="px-6 py-4">{{ $facility->room->roomname }}</td>
                    ...
                    @empty
                        <tr>
                            <td colspan="3" class="px-6 py-4 text-center text-stone-500">No facilities found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
